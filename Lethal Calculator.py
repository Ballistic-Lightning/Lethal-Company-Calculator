...
def calcLogo():
    print("""
        __         __  __          __   ______      __           __      __                _    __ ___ ______
       / /   ___  / /_/ /_  ____ _/ /  / ____/___ _/ /______  __/ /___ _/ /_____  _____   | |  / /<  // __  /
      / /   / _ \/ __/ __ \/ __ `/ /  / /   / __ `/ / ___/ / / / / __ `/ __/ __ \/ ___/   | | / / / // / / /
     / /___/  __/ /_/ / / / /_/ / /  / /___/ /_/ / / /__/ /_/ / / /_/ / /_/ /_/ / /       | |/ / / // /_/ / 
    /_____/\___/\__/_/ /_/\__,_/_/   \____/\__,_/_/\___/\__,_/_/\__,_/\__/\____/_/        |___(_)_(_)____/  
    """)
        ...
        if quotaMasterSheet[i][0] == '-':
            while True:
                ...
                if inputOpt == "y":
                    ...
                    while True:
                        try:
                            quotaMasterSheet[i][0] = int(input("Enter Quota Amount:"))
                            sheetPredict(quotaMasterSheet)
                            break
                        except ValueError:
                            errThrow("inv")
...
def randMath(timesFufil, randValue, quotaAmount):
    return float((100 * (1 + ((timesFufil ** 2) / 16)) * (randValue + 0.5)) + quotaAmount)

def rollMath(timesFufil, currentQuota, previousQuota):
    return round(float((currentQuota - previousQuota) / (100 * (1 + ((timesFufil ** 2) / 16))) - 0.5), 2)
